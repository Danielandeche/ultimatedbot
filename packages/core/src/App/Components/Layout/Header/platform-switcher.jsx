...
const TiktokIcon = (props) => (
    <svg width="30px" height="25px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (is_logged_in || is_logging_in ? !is_landing_company_loaded : app_routing_history.length === 0) ? (
        ...
        <React.Fragment>
            ...
            >
                ...
                <a href="https://t.me/binarytools" target="_blank" rel="noopener noreferrer">
                    <Icon
                ...
                <div className='platform-switcher__separator' />
                <a href="https://www.youtube.com/@BinarytoolTutorial" target="_blank" rel="noopener noreferrer">
                    <YouTubeIcon
                        className='platform-switcher__icon'
                        width={25}
                        height={25}
                ...
                <div className='platform-switcher__separator' />
                <a href="https://www.tiktok.com/@binarytools" target="_blank" rel="noopener noreferrer">
                    <TiktokIcon
                        className='platform-switcher__icon'
                        width={25}
                        height={25}
