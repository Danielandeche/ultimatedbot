...
export const OSCARS_GRIND: TDescriptionItem[] = [
    {
        type: 'subtitle',
        content: [localize('Exploring the Oscar’s Grind strategy in MrDuke Bot')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used for Oscar’s Grind strategy in MrDuke Bot.')],
    },
    {
        type: 'text',
        content: [
