...
const CopyTrading = observer(() => {
    ...
    // Include run_panel functionality
    const [isRunPanelOpen, setIsRunPanelOpen] = React.useState(false);
    const toggleRunPanel = () => setIsRunPanelOpen(!isRunPanelOpen);
        ...
        <div className='main_copy'>
            ...
            {isRunPanelOpen && (
                <div className="run-panel">
                    {/* Add run panel content here */}
                </div>
            )}
            <button className="toggle-run-panel-button" onClick={toggleRunPanel}>
                Toggle Run Panel
            </button>
        </div>
    );
