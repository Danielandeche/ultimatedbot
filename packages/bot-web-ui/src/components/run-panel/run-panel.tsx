...
const RunPanel = observer(() => {
    ...
    const { BOT_BUILDER, COPYTRADING, ANALYSISTOOL, TRADING_VIEW, CHART } = DBOT_TABS;
    ...
    const show_run_panel = [BOT_BUILDER, COPYTRADING, ANALYSISTOOL, TRADING_VIEW, CHART].includes(active_tab) || active_tour;
