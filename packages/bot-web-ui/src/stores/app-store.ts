...
export default class AppStore {
    ...
    getErrorForNonEuClients = () => ({
        ...
        title: localize('Deriv Software isunavailable for this account'),
    ...
    getErrorForEuClients = (is_logged_in = false, country: string | undefined = undefined) => {
        return {
            text: ' ',
            title: is_logged_in
                ? localize(`Deriv Software isnot available for ${country || 'EU'} clients`)
                : localize(`Deriv Software isunavailable in ${country || 'the EU'}`),
