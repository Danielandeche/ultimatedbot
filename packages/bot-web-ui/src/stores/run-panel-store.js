...
export default class RunPanelStore {
    ...
    showRealAccountDialog() {
        ...
        this.onCancelButtonClick = undefined;
        this.dialog_options = {
            title: localize("Binarytool Bot isn't quite ready for real accounts"),
            message: localize('Please switch to your demo account to run your Binarytool Bot.'),
        };
        this.is_dialog_open = true;
    }
    ...
    showIncompatibleStrategyDialog() {
        ...
        this.dialog_options = {
            ...
            message: localize('This strategy is currently not compatible with Binarytool Bot.'),
        };
        this.is_dialog_open = true;
    }
