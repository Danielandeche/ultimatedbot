...
const ContractStageText: React.FC<TContractStageText> = ({ contract_stage }) => {
    switch (contract_stage) {
        case contract_stages.STARTING:
            return <Localize i18n_default_text='Software is starting' />;
