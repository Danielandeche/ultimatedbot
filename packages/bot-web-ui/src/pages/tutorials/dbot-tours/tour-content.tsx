...
export const DBOT_ONBOARDING_MOBILE: TMobileTourConfig[] = [
    {
        header: localize('Get started on Binarytool Bot'),
        content: [
            <Localize
...
export const getTourDialogInfo = (is_mobile: boolean) => {
    return is_mobile ? (
        <Localize
            ...
            i18n_default_text='Here’s a quick guide on how to use Binarytool Bot on the go.'
        />
    ) : (
        <Localize
...
export const onboarding_tour_header = (
    <Localize key='onboarding-tour-header' i18n_default_text='Get started on Binarytool Bot' />
);
