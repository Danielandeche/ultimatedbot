...
export const DBOT_ONBOARDING_MOBILE: TMobileTourConfig[] = [
    {
        header: localize('Get started on Ultimate Traders Bot'),
        content: [
            <Localize
...
export const getTourDialogInfo = (is_mobile: boolean) => {
    return is_mobile ? (
        <Localize
            ...
            i18n_default_text='Here’s a quick guide on how to use Ultimate Traders Bot on the go.'
        />
    ) : (
        <Localize
...
export const onboarding_tour_header = (
    <Localize key='onboarding-tour-header' i18n_default_text='Get started on Ultimate Traders Bot' />
);
